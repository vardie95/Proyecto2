 ...
 * @author Luis Diego
 */
public class RegistroColor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registro Color");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroColor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroColor().setVisible(true);
            }
        });
    }
